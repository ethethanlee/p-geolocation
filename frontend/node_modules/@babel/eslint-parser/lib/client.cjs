var _class2, _worker, _worker_threads, _worker_threads_cache;
...
exports.WorkerClient = (_worker = new WeakMap(), (_class2 = class WorkerClient extends Client {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _worker, {
      writable: true,
      value: new (_classStaticPrivateFieldSpecGet(WorkerClient, _class2, _worker_threads).Worker)(path.resolve(__dirname, "../lib/worker/index.cjs"), {
        env: _classStaticPrivateFieldSpecGet(WorkerClient, _class2, _worker_threads).SHARE_ENV
      })
    });
